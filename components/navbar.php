    ...
    <body>
        ...
        <nav>
            ...
            <ul class="menu-items">
                ...
                <li class="menu-items-li"><a class="navv-item nav-item-about" href="about-us.php"><svg
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="menu-icon">
                            <path
        ...
        <script>
            ...
            let currentCssLink = document.getElementById('currentCssLink')

            if (current_url.indexOf("account.php") != -1) {
                currentCssLink.setAttribute('href', "style/darktheme_css/dark_account.css");
                document.querySelector(".nav-item.active")?.classList.remove('active');
                document.querySelector(".nav-item-account").classList.add('active');
            } else if (current_url.indexOf("feed.php") != -1) {
                currentCssLink.setAttribute('href', "style/darktheme_css/dark_feed.css");
                document.querySelector(".nav-item.active")?.classList.remove('active');
                document.querySelector(".nav-item-feed").classList.add('active');

            } else if (current_url.indexOf("about-us.php") != -1) {
                currentCssLink.setAttribute('href', "style/darktheme_css/dark_about.css");
                document.querySelector(".nav-item.active")?.classList.remove('active');
                document.querySelector(".nav-item-feed").classList.add('active');
            }
        </script>