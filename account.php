...
<html>
    ...
    <link rel="stylesheet" href="style/account.css"> -->
        ...
        <link rel="stylesheet" href="style/darktheme_css/dark_account.css?t=<?php echo time(); ?>" id="theme">
                    ...
                    <a href="account.php?username=<?php echo $username_row; ?>">
                        <div class=" user-profile">
                            <img class="user-avatar"
                                src="https://api.dicebear.com/6.x/initials/png?seed=<?php echo $fname ?>&size=128" alt=" User 1">
                            <div class="user-info">
