...
<html>
    ...
    <link rel="stylesheet" href="style/lighttheme_css/light_message.css?t=<?php echo time(); ?>" id="theme">   -->
        ...
        <link rel="stylesheet" href="style/darktheme_css/dark_message.css?t=<?php echo time(); ?>" id="theme">
    ...
    <body>
        ...
        <div class="message-body">
            <div class="message-window">
                <div class="message-window-head">
                    <ul>
                        <li>
                            <a href="account.php?username=<?php if ($username[$recp1] != $_SESSION['username'])
                            {
                                echo $username[$recp1];
                            } else
                            {
                                echo $username[$recp2];
                            } ?>" style="text-decoration: none;"><img src="img/user.png" alt="profile" class="<?php if ($status[$recp2] == 1)
                             {
                                 echo "message-account-profpic-online";
                             } else
                             {
                                 echo "message-account-profpic-offline";
                             } ?>"></a>
                        </li>
                        <li>
                            <?php if ($username[$recp1] != $_SESSION['username'])
                            {
                                echo "<b>" . $name[$recp1] . "</b>";
                            } else
                            {
                            ...
                            <?php if ($status[$recp2] == 1)
                            {
                                echo "<small><br>online</small>";
                            } else
                            {
                                echo "<small><br>offline</small>";
                            } ?>
                        </li>
                    </ul>
                </div>
                ...
                <script>
                    document.getElementById("message-window-message-box").scrollTo(0, document.getElementById(
                        "message-window-message-box").scrollHeight);
                </script>
        ...
        <div class="footer" style="height:16rem">
            <p style="  font-size: x-large;margin-top:0;">Social Hood</p>
            <ul class="footer-icons">
                <li class="foot-item">
                    <a href="https://github.com/Mayuresh-22/Social Hood" class="foot-link"><i
                ...
                <li class="foot-item">
                    <a href="https://www.linkedin.com/in/mayureshchoudhary/" class="foot-link"><i
            ...
            <p style="font-size:0.9rem;">This website is only for educational purposes and does not try to replicate any
