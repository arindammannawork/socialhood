...
?>
<html>
    <title>Social Hood - About Us</title>
    ...
    <link rel="stylesheet" href="style/about.css"> -->
        ...
        <link rel="stylesheet" href="style/darktheme_css/dark_about.css?t=<?php echo time(); ?>" id="theme">
        ...
        <nav>
            ...
            <!-- <ul>
                <img src="img/dark_img/MoonIcon.png" alt="Theme Icon" height="19" width="19" id="theme-icon"
                    id="theme-toggle" class="theme-button" onclick="changeTheme()">
            </ul> -->
            ...
            <ul class="menu-items">
                ...
                <li class="menu-items-li"><a class="navv-item active" href="about-us.php"><svg
    ...
    <ul>
        ...
        <div class="about-us">
            <center><img class="about-us-logo" src="logo/Social Hood logo3.png" alt="logo"></center>
            <h2>About Us</h2>
